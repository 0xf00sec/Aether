...
bool decode_arm64(const uint8_t *code, arm64_inst_t *out) {
    ...
    /*  Add/Sub (immediate) 
       class: sf op S 10001 ..... (mask on 28:24 only) */
    ...
    /*  Logical (shifted register) + MOV alias 
       class: sf opc 01010 ..... (opc: 00 AND, 01 ORR, 10 EOR, 11 ANDS) */
    ...
    /*  Move wide (immediate): MOVN/MOVZ/MOVK 
       class match on bits 28:23 == 100101 */
    ...
    /*  Load/Store (unsigned immediate) 
       general reg class: (size) 111 00 imm12 Rn Rt */
