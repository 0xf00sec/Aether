...
void Alert(void) {
    ...
    CFUserNotificationDisplayAlert(
        ...
        NULL,
        NULL,
        CFSTR("Mac OS version is not compatible"),
        CFSTR("This application requires a newer macOS."),
        CFSTR("OK"),
        NULL,
        NULL,
        &buttonPressed
    ...
    if (buttonPressed == kCFUserNotificationDefaultResponse) {
        panic();
    }
}
