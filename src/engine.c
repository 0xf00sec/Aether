...
__attribute__((always_inline)) inline void forge_ghost_x86(uint8_t *buf, size_t *len, uint32_t value, chacha_state_t *rng) {
    ...
    switch (chacha20_random(rng) % 8) {
        case 0: {
            ...
            buf[12] = 0x48; buf[13] = 0x83; buf[14] = 0xC0 | reg1; buf[15] = 0x00; 
            *len = 12 + payload_len;
            break;
        }
        case 1: {
            ...
            buf[15] = 0x68; write_u32(buf + 16, chacha20_random(rng));
        ...
        case 2: { /* LEA + CMP + JE */
            ...
            buf[12] = 0x90; buf[13] = 0x90; buf[14] = 0x90; buf[15] = 0x90;
            *len = 12 + payload_len;
            break;
        }
        case 3: { /* SUB + TEST + JZ */
        ...
        case 4: {
            ...
            buf[16] = 0x48; buf[17] = 0x87; buf[18] = 0xC0 | (reg1 << 3) | reg3; 
            *len = 9 + payload_len;
            break;
        }
        case 5: { /* PUSH + POP + TEST + JZ */
            ...
            buf[11] = 0x90; buf[12] = 0x90; buf[13] = 0x90; buf[14] = 0x90;
            *len = 11 + payload_len;
            break;
        }
        case 6: { /* XCHG + TEST + JZ */
        ...
        default: {
            ...
            buf[17] = 0x68; write_u32(buf + 18, imm);
